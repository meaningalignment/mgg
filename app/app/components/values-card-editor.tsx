import { DeduplicatedCard, type ValuesCard as VCard } from "@prisma/client"
...
export function ValuesCardEditor({ card, cardType }: { card: SerializeFrom<VCard>, cardType: 'canonical' | 'personal' }) {
  ...
  return <div key={card.id}>
    <ValuesCard card={card as any as DeduplicatedCard} />
