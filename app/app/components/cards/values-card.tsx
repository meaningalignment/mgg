...
export type ValuesCardData = { title: string, instructionsShort: string, instructionsDetailed?: string | null, evaluationCriteria: string[] }
...
export default function ValuesCard({ card, header, detailsInline, editButton }: Props) {
  return (
    ...
    >
      ...
      <p className="text-md text-neutral-500 dark:text-neutral-300">{card.instructionsShort}</p>
