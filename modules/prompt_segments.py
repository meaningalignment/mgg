...
The choice type should be a very short sentence summarizing what kind of thing you, the chatbot, are trying to choose in this situation. It should start with 'Choosing'. For example, 'Choosing how to comfort someone', or ‘Choosing whether to comfort someone or encourage them to level up’ or ‘Choosing witty responses’."""
